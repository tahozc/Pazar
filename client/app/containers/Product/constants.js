...
export const FETCH_RECOMMENDED_PRODUCTS =
  "src/Product/FETCH_RECOMMENDED_PRODUCTS";
export const FETCH_STORE_PRODUCTS = "src/Product/FETCH_STORE_PRODUCTS";
export const FETCH_PRODUCT = "src/Product/FETCH_PRODUCT";
export const FETCH_TAGS = "src/Product/FETCH_TAGS";
...
export const SET_ADD_PRODUCT_LOADING = "src/Product/SET_ADD_PRODUCT_LOADING";
...
export const SET_PRODUCTS_RECOMMEND_LOADING =
  "src/Product/SET_PRODUCTS_RECOMMEND_LOADING";
